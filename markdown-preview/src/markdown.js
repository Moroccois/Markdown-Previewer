...
handleChange(event) {
  ...
  render() {
    return (
      <div id="markdownPreviewer" className="container-fluid">
      
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          <h1 className="display-4">React Markdown Previewer</h1>
        </div>
      </div>
        ...
        <small>Markdown Previewer created by Tonya Fowler</small>
      </div>
